...
- **外观**：浅色 / 深色主题，人民币 / 美元费用显示（实时汇率），中文 / 英文双语；**沉浸光感**三档可调（弱 / 均衡 / 强，映射系统 HDS 材质等级）
- **体验细节**：悬浮导航栏（液态玻璃材质、跟随左右手、随滚动自动隐藏/显示）、HDS 沉浸标题栏（内容滚入栏下触发渐变模糊，材质与导航栏同档位）、滚动弹性回弹、沉浸式布局适配系统安全区、数字单位本地化（中文万/亿，英文 k/M）
